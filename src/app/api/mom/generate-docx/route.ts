...
//     // --- PERBAIKAN: Hapus `columnWidths` ---
//     // Menghapus `columnWidths` agar tidak konflik dengan `columnSpan`
//     // const columnWidths = Array(totalApproversCount).fill(Math.floor(100 / totalApproversCount));

//     const approverTable = new Table({
//         width: { size: 100, type: WidthType.PERCENTAGE },
//         // Hapus properti `columnWidths` dari sini
...
//     // --- PERBAIKAN 1: Mengubah query Prisma ---
//     const momData = await prisma.mom.findUnique({
//       where: { id: parseInt(momId as string) },
//       include: {
//         company: true, 
//         attachments: { include: { files: true } },
//         next_actions: true,
//         // 'approvers: true' diganti dengan relasi join table
//         mom_approvers: {
//           include: {
//             approver: true // Ambil data approver dari join table
//           }
//         }
//       },
//     });
...
//     // --- PERBAIKAN 2: Menyesuaikan Logika Grup Approver ---
//     const telkomsatCompanyName = "Telkomsat";
//     const groupedApprovers: { [key: string]: string[] } = {};

//     // Iterasi melalui 'mom_approvers' (hasil query baru)
//     for (const momApprover of momData.mom_approvers) {
//       const approver = momApprover.approver; // Dapatkan objek approver yang di-nest
      
//       if (!approver) continue; // Keamanan jika data approver tidak ada
...
//         groupedApprovers[companyName] = [];
//       }
//       // Gunakan 'approver.name' dari objek yang di-nest
//       groupedApprovers[companyName].push(approver.name);
//     }
//     // --- AKHIR PERBAIKAN 2 ---
